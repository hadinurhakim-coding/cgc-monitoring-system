 ...
 * Hanya di-import dari server — memakai master `assessment-data` tanpa membawa ke bundle klien.
 */
import { assessmentData as acgsMasterStructure } from "./assessment-data.js";
import {
